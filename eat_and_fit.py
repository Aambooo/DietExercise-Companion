...
col1, col2, col3, col4, col5, col6, col7, col8 = st.columns(
    [0.5, 0.5, 1, 0.75, 1, 0.75, 0.5, 0.5]
)
with col4:
    st.image(image="images\logo.png", width=140)
with col5:
    st.markdown(
        """<br/><h1 style="display: inline;">Eat & Fit</h1>
    ...
    if body == 0:
        ...
        with engine.connect() as conn:
            ...
            lcb1_result = conn.execute(
                ...
                {"id": low_carb_breakfast_detail.id1},
            ).fetchone()
            lcb2_result = conn.execute(
                "SELECT * FROM Dish WHERE Id = :id",
                {"id": low_carb_breakfast_detail.id2},
            ).fetchone()
            lcl1_result = conn.execute(
                "SELECT * FROM Dish WHERE Id = :id",
                {"id": low_carb_lunch_detail.id1},
            ).fetchone()
            lcl2_result = conn.execute(
                "SELECT * FROM Dish WHERE Id = :id",
                {"id": low_carb_lunch_detail.id2},
            ).fetchone()
            lcd1_result = conn.execute(
                "SELECT * FROM Dish WHERE Id = :id",
                {"id": low_carb_dinner_detail.id1},
            ).fetchone()
            lcd2_result = conn.execute(
                "SELECT * FROM Dish WHERE Id = :id",
                {"id": low_carb_dinner_detail.id2},
            ).fetchone()
            ...
            lcb1_result = conn.execute(
                "SELECT * FROM Dish WHERE Id = :id",
                {"id": moderate_carb_breakfast_detail.id1},
            ).fetchone()
            lcb2_result = conn.execute(
                "SELECT * FROM Dish WHERE Id = :id",
                {"id": moderate_carb_breakfast_detail.id2},
            ).fetchone()
            lcl1_result = conn.execute(
                "SELECT * FROM Dish WHERE Id = :id",
                {"id": moderate_carb_lunch_detail.id1},
            ).fetchone()
            lcl2_result = conn.execute(
                "SELECT * FROM Dish WHERE Id = :id",
                {"id": moderate_carb_lunch_detail.id2},
            ).fetchone()
            lcd1_result = conn.execute(
                "SELECT * FROM Dish WHERE Id = :id",
                {"id": moderate_carb_dinner_detail.id1},
            ).fetchone()
            lcd2_result = conn.execute(
                "SELECT * FROM Dish WHERE Id = :id",
                {"id": moderate_carb_dinner_detail.id2},
            ).fetchone()
